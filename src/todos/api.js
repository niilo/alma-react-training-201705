...
const fakeDatabase: Db = {
  todos: {
    'af5463a3-73e9-4a6c-8dce-b1281606f8b8': {
      id: 'af5463a3-73e9-4a6c-8dce-b1281606f8b8',
      name: 'Go to gym',
      assignee: 'John',
      done: false
    },
    '38c1c4bb-7c84-4b97-8464-343a3c7f4312': {
      id: '38c1c4bb-7c84-4b97-8464-343a3c7f4312',
      name: 'Do the laundry',
      assignee: 'Mark',
      done: true
    }
...
export const getTodo = (id: string) =>
  delay(500).then(() => fakeDatabase.todos[id])
...
export const editTodo = (todo: TodoItem) =>
  delay(500).then(() => (fakeDatabase.todos[todo.id] = { ...todo }))
